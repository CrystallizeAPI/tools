...
import importTentantDump from '../core/use-cases/importTentantDump.js';
...
export default async (args: string[], flags: any): Promise<number> => {
    ...
    if (!isInteractive) {
        ...
        await importTentantDump(identifier, specFilePath, credentials, (eventName: string, message: string | any) => {
